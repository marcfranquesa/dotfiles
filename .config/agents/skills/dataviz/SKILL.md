...
name: dataviz
description: >-
  Design and verify project-owned charts, plots, dashboards, and exported data
  visualizations in HTML/React, SVG, Python/R/JS, or image outputs. Use when
  choosing form, palette, marks, interaction, or accessibility for a deliverable.
  Do not use for inline, in-conversation visual explanations handled by the host's
  visualization capability.
metadata:
  upstream_repository: "https://github.com/asgeirtj/system_prompts_leaks"
  upstream_path: "Anthropic/claude-code/skills/dataviz"
  upstream_revision: "cf732468e54f62f23f46e7c277992626a7f8bf9e"
...
Use this skill for durable, project-owned visualization outputs such as source
files, application components, reports, dashboards, and exported figures. For an
inline visual explanation rendered directly in conversation, defer to the host's
visualization capability so its output contract and design tokens remain
authoritative.
...
Imported from
[`asgeirtj/system_prompts_leaks`](https://github.com/asgeirtj/system_prompts_leaks/tree/cf732468e54f62f23f46e7c277992626a7f8bf9e/Anthropic/claude-code/skills/dataviz),
path `Anthropic/claude-code/skills/dataviz`, pinned at revision
`cf732468e54f62f23f46e7c277992626a7f8bf9e`. The local adaptation changes the
frontmatter and adds the scope boundary above; the visualization method,
references, and validator scripts come from that snapshot.
